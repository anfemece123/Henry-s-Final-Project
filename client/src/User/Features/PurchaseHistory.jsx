    ...
    <div className="py-14 px-4 md:px-6 2xl:px-20 2xl:container 2xl:mx-auto">
      <div className="flex justify-start item-start space-y-2 flex-col ">
        <h1 className="text-3xl lg:text-4xl font-semibold leading-7 lg:leading-9  text-gray-800">
          NUMERO DE ORDEN #1283123
        </h1>
        <p className="text-base font-medium leading-6 text-gray-600">
          HORA Y FECHA DE LA ORDEN(TIMESTAMP)
        </p>
      </div>
            ...
            <div className="mt-4 md:mt-6 flex  flex-col md:flex-row justify-start items-start md:items-center md:space-x-6 xl:space-x-8 w-full ">
              <div className="pb-4 md:pb-8 w-full md:w-40">
                <img
                  ...
                  src="https://f.fcdn.app/imgs/9338db/boomerang.uy/boomuy/df39/original/catalogo/BG12850-01-1/600x690/tshirt-lycra-m-c-adulto-navy.jpg"
                  alt="dress"
                />
                <img
              ...
              <div className="border-b border-gray-200 md:flex-row flex-col flex justify-between items-start w-full  pb-8 space-y-4 md:space-y-0">
                <div className="w-full flex flex-col justify-start items-start space-y-8">
                  ...
                  <div className="flex justify-start items-start flex-col space-y-2">
                    <p className="text-sm leading-none text-gray-800">
                      <span className="text-gray-300">Genre: </span> GENERO
                    </p>
                    <p className="text-sm leading-none text-gray-800">
                      <span className="text-gray-300">Size: </span> TAMAÑO
                    </p>
                    <p className="text-sm leading-none text-gray-800">
                      <span className="text-gray-300">Color: </span> ACA EL
                      COLOR
                    </p>
                  </div>
                </div>
                <div className="flex justify-between space-x-8 items-start w-full">
                  <p className="text-base xl:text-lg leading-6">
                    LO QUE VALE POR CADA UNA
                    {/* <span className="text-red-300 line-through"> $45.00</span> */}
                  </p>
                  <p className="text-base xl:text-lg leading-6 text-gray-800">
                    CANTIDAD DE ESTA MISMA PRENDA
                  </p>
                  <p className="text-base xl:text-lg font-semibold leading-6 text-gray-800">
                    VALOR TOTAL DEPENDIENDO DE LA CANTIDAD
                  </p>
                </div>
              </div>
            </div>
